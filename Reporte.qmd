...
+--------------------+-----------+-----------+-----------+
|     Seroestatus    | Estimador | Intervalo | Intervalo |
|                    |  puntual  |  inferior |  superior |
+====================+===========+===========+===========+
|      Eficiencia de la vacuna (Cualquier serotipo)      |
+--------------------+-----------+-----------+-----------+
| Independientemente |      79.6 |      70.0 |      86.3 |
|   del serostatus   |           |           |           |
+--------------------+-----------+-----------+-----------+
|   Con exposición   |      89.2 |      77.6 |      95.6 |
|       previa       |           |           |           |
+--------------------+-----------+-----------+-----------+
|   Sin exposición   |      73.6 |      57.6 |      83.7 |
|       previa       |           |           |           |
+--------------------+-----------+-----------+-----------+
|            Eficiencia de la vacuna (DENV-1)            |
+--------------------+-----------+-----------+-----------+
| Independientemente |      89.5 |      78.7 |      95.0 |
|   del serostatus   |           |           |           |
+--------------------+-----------+-----------+-----------+
|   Con exposición   |      96.8 |      81.0 |      99.8 |
|       previa       |           |           |           |
+--------------------+-----------+-----------+-----------+
|   Sin exposición   |      85.6 |      69.1 |      94.0 |
|       previa       |           |           |           |
+--------------------+-----------+-----------+-----------+
|            Eficiencia de la vacuna (DENV-2)            |
+--------------------+-----------+-----------+-----------+
| Independientemente |      69.6 |      50.8 |      81.5 |
|   del serostatus   |           |           |           |
+--------------------+-----------+-----------+-----------+
|   Con exposición   |      83.7 |      63.1 |      93.5 |
|       previa       |           |           |           |
+--------------------+-----------+-----------+-----------+
|   Sin exposición   |      57.9 |      20.8 |      78.1 |
|       previa       |           |           |           |
+--------------------+-----------+-----------+-----------+
|      DENV-3 y DENV-4 No presentaron observaciones      |
+--------------------------------------------------------+
:Resultados de la eficacia de la vacuna (en porcentaje)
...
La ausencia de circulación de DENV-3 y DENV-4 impidió estimar eficacia contra esos serotipos. Además, por el tiempo de seguimiento algunos efectos o eventos tardíos podrían no haberse manifestado aún puediendo ser estos posibles sesgos en el estudio.
...
Según el [boletin epidemiológico nacional de la semana epidemiológica número 23](https://www.argentina.gob.ar/noticias/actualizacion-del-boletin-epidemiologico-nacional-de-la-se-ndeg-23)^[Dirección de epidemiología. (17/06/2025). Boletín epidemiológico nacional. https://www.argentina.gob.ar/noticias/actualizacion-del-boletin-epidemiologico-nacional-de-la-se-ndeg-23] reporta que en lo que va de la temporada 2024-2025 (SE31/2024 hasta la SE23/2025), se notificaron en Argentina 75.072 casos sospechosos de dengue y dengue durante el embarazo en el Sistema Nacional de Vigilancia de la Salud (SNVS 2.0) de los cuales 8258 fueron confirmados por laboratorio y 8674 por nexo clínico epidemiológico (El nexo epidemiológico consiste en confirmar los casos probables de dengue a partir de casos confirmados por laboratorio utilizando la asociación de persona, tiempo y espacio.), con un total de 16.932 casos de dengue. La incidencia acumulada a nivel país para la temporada actual es de 36 casos cada 100.000 habitantes. 
